# Mount Marketing Website

This is a simple static brochure website for Mount Marketing. It has no build step, so it can be edited directly and opened in a browser.
...
- Update the contact email by changing the `mailto:` link in the contact section of `index.html`.
